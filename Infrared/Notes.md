...
<img width="590" height="510" alt="Screenshot 2026-05-19 at 3 54 14 PM" src="https://github.com/user-attachments/assets/cbc75752-bc65-4c3e-abc3-1c1721b61c1a" />
  ...
  The magnitude of the pulses detected at the hole were really low, around 100mV~. Highly likely that we will use a Schmitt Trigger or an amplifier to largen the pulse amplitude. Also attempted at making an algorithm to identify the infrared wavelength (312 or 547), though it was highly inaccurate (refer to initialtestcode.ino). The premise is that we would calculate the average number of pulses in a time window to determine roughly which of 312 or 547 the pulses lean towards.
